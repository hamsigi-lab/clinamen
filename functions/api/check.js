...
{"issues": [{"level": "높음|중간|낮음|정보", "category": "카테고리명", "title": "오류 제목", "desc": "상세 설명", "suggestion": "수정 전 → 수정 후 예시 (없으면 null)", "quote": "오류가 있는 원문 단어·구절 (없으면 null)", "questionNum": 3, "boundingBox": {"y_min": 0, "x_min": 0, "y_max": 100, "x_max": 1000}}]}
...
필드 규칙:
- suggestion: 구체적인 수정 예시. 예) "틀리다 → 다르다", "3점 → 5점". 수정 예시를 만들 수 없는 경우 null
- questionNum: 오류가 속한 문항 번호 (정수). 특정 문항과 무관하면 null
- boundingBox: 시험지 이미지(이미지 1) 기준 1000×1000 좌표. **오류 단어·구절·수식만** 최대한 좁게 감쌀 것 — 문항 전체 금지. 시험지와 무관한 항목은 null
- quote: 오류 해당 원문을 그대로 옮길 것. boundingBox가 null이면 quote도 null
