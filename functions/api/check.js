...
{"issues": [{"level": "높음|중간|낮음|정보", "category": "카테고리명", "title": "오류 제목", "desc": "상세 설명 및 수정 방향", "quote": "오류가 있는 원문 단어·구절", "boundingBox": {"y_min": 0, "x_min": 0, "y_max": 100, "x_max": 1000}}]}
...
boundingBox 규칙 (매우 중요):
- 시험지 이미지(이미지 1) 기준 1000×1000 좌표
- 오류가 있는 **단어·구절·수식·기호**만 최대한 좁게 감싸야 함 — 문항 전체를 잡지 말 것
- 예: 맞춤법 오류 → 해당 단어 하나만, 배점 오류 → 배점 숫자만, 번호 오류 → 번호 부분만
- 시험지 이미지와 무관한 항목(문항정보표 오류, 채점기준표 누락 등)은 "boundingBox": null
- quote: 오류 해당 원문 단어·구절을 그대로 옮길 것 (boundingBox가 null이면 quote도 null)
